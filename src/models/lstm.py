...
def run_lstm(train_data, test_data, lookback=10, epochs=30, batch_size=64, 
             use_early_stopping=True, verbose=1, multivariate=False):
    """
    Train and evaluate an LSTM model for TPS forecasting
    ...
    print("\n  ⚙️  LSTM Configuration ({})".format(mode))
